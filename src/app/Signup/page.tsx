...
const Signup = () => {
  ...
  const onClickHandler = (e:any) => {
    fetch('/api/signup', {
      ...
      body: JSON.stringify({provider: "credentials", ...user})
    })
          ...
          >
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  id="email"
                  className="border p-2 dark:bg-indigo-700 dark:text-gray-300  dark:border-gray-700 shadow-md placeholder:text-base border-gray-300 rounded-lg w-full"
                  type="text"
              ...
              <div>
                ...
                <input
                  onChange={onChangeHandler}
                  id="password"
                  className="border p-2 shadow-md dark:bg-indigo-700 dark:text-gray-300  dark:border-gray-700 placeholder:text-base border-gray-300 rounded-lg w-full"
                  type="password"
              ...
              <button
                ...
                className="bg-gradient-to-r dark:text-gray-300 from-blue-500 to-purple-500 shadow-lg mt-12 p-2 text-white rounded-lg w-full hover:scale-105 hover:from-purple-500 hover:to-blue-500 transition duration-300 ease-in-out"
                type="submit"
              >
                SIGN UP
              </button>
            ...
            <div className="flex flex-col mt-4 items-center justify-center text-sm">
              <h3 className="dark:text-gray-300">
                ...
                >
                  <span
                    className="bg-left-bottom bg-gradient-to-r from-blue-400 to-blue-400 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out ml-1"
                  >
                    Login
                  </span>
                </Link>
            ...
            >
              ...
              onClick={()=>signIn("github")}
                className="flex items-center text-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
